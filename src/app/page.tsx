    ...
    <header className="fixed top-0 w-full z-50 bg-black/50 backdrop-blur-md shadow-lg">
      <nav className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-6 items-center">
          <motion.a href="#home" onClick={handleSmoothScroll} className="text-gray-300 hover:text-cyan-400 transition-colors" variants={fadeIn}>Home</motion.a>
    ...
    <div className="container mx-auto">
      ...
      >
        ...
        >
          ...
          <a href={resumeData.resumeUrl} download className="inline-block px-8 py-3 text-white font-bold rounded-full shadow-lg border-2 border-indigo-600 hover:bg-indigo-600 transition-all duration-300 transform hover:scale-105">
            Download CV
          </a>
        </motion.div>
        ...
        >
          <a href={resumeData.contact.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-cyan-400 transition-colors">
          ...
          <a href={resumeData.contact.github} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-cyan-400 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-8 w-8" fill="currentColor">
          ...
          <a href={resumeData.contact.twitter} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-cyan-400 transition-colors">
          ...
          <motion.div key={index} className="bg-gray-900 p-8 rounded-2xl shadow-lg border border-gray-800" variants={fadeIn}>
            ...
            <div className="mt-8 flex space-x-4">
              ...
              <a href={project.codeUrl} target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 px-6 py-3 font-bold rounded-full text-white transition-all duration-300 transform hover:scale-105 bg-gray-800 hover:bg-gray-700 border border-gray-700">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M12.316 3.051a1 1 0 01.632 1.554l-1.474 2.148a1 1 0 01-1.632-1.128l1.474-2.148a1 1 0 011.002-.574zM16.994 6.945a1 1 0 01.31 1.777l-2.072 1.13a1 1 0 01-1.383-1.13l2.072-1.13a1 1 0 011.002-.577zM7.006 17.055a1 1 0 01-.31-1.777l2.072-1.13a1 1 0 011.383 1.13l-2.072 1.13a1 1 0 01-1.003.577zM4.022 13.567a1 1 0 01-.632-1.554l1.474-2.148a1 1 0 111.632 1.128l-1.474 2.148a1 1 0 01-1.003.574z" clipRule="evenodd" />
                  <path fillRule="evenodd" d="M12 2a1 1 0 011 1v1h-2V3a1 1 0 011-1zM10 2a1 1 0 011 1v1H9V3a1 1 0 011-1zM8 2a1 1 0 011 1v1H7V3a1 1 0 011-1zM6 2a1 1 0 011 1v1H5V3a1 1 0 011-1zM4 2a1 1 0 011 1v1H3V3a1 1 0 011-1zM2 2a1 1 0 011 1v1H1V3a1 1 0 011-1z" clipRule="evenodd" />
                  <path fillRule="evenodd" d="M18 2h-2v1h2V2zM16 2h-2v1h2V2zM14 2h-2v1h2V2zM20 2h-2v1h2V2zM22 2h-2v1h2V2zM24 2h-2v1h2V2z" clipRule="evenodd" />
        ...
        <motion.div className="lg:w-1/2" variants={fadeIn}>
          ...
          <form className="space-y-4">
            ...
            <p className="text-center text-sm text-gray-500 mt-2">
              Prefer email? Reach out directly at <a href={`mailto:${resumeData.contact.email}`} className="text-cyan-400 hover:underline">{resumeData.contact.email}</a>
            </p>
          </form>
        </motion.div>
      </motion.div>
