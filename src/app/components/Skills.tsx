...
function Skills (){
      ...
      const resumeData = {
        ...
        resumeUrl:
          "https://drive.google.com/file/d/1zqu5xwFU4EPC70p4A3D3NTH21eHqE0XS/view?usp=sharing", // Placeholder for your resume file
        ...
        skills: [
          ...
          },
          {
            ...
            icon: (
              <AdjustmentsHorizontalIcon className="h-6 w-6 text-red-400" />
            ),
          },
          {
